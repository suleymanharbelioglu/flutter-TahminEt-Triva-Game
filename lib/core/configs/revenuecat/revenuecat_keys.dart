/// RevenueCat **public** SDK anahtarları (Play / App Store).
/// Dashboard: Project settings → API keys veya Apps & providers → ilgili app.
///
/// Buraya yapıştır; `--dart-define` kullanmak zorunda değilsin.
